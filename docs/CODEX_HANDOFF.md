...
- Latest released version: `1.2.7`
- Latest release tag: `v1.2.7`
- Latest release commit: see tag `v1.2.7`
- Current package name:
  `MetaDataIAPlugin_2f42c46c-9e3f-48cb-99b6-7f41f12d9b83_1_2_7.pext`
- Release page:
  https://github.com/Naerian/playnite-nx-metadata-ia/releases/tag/v1.2.7
- Public package SHA-256 verified for v1.2.7:
  `D9AFA282D5A1D89386CF3ACB3FF3EFD935F82F09F3ED33EE721A482F6B884DDF`
...
- Media sources include Steam public assets, SteamGridDB, RAWG, MobyGames, IGDB,
  PS Store, Xbox and source integration context.
- Automatic media selection with source priority, quality/resolution preferences,
  crop/output settings and fallback behavior.
- Manual media picker with candidate selection, preview and browser links.
...
Use clear release notes that list features and changes only when the user asks
for concise release descriptions.
